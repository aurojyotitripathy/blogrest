...
import com.nextcloudapps.blogapi.model.user.Address;
import com.nextcloudapps.blogapi.model.user.Company;
import com.nextcloudapps.blogapi.model.user.Geo;
...
import com.nextcloudapps.blogapi.exception.AccessDeniedException;
...
public class UserServiceImpl implements UserService {
	...
	public List<UserProfile> getAllUserProfile() {
		...
		for(User user:users){
			profiles.add(new UserProfile(user.getId(), user.getUsername(), user.getFirstName(), user.getLastName(),
					user.getCreatedAt(), user.getEmail(), user.getAddress(), user.getPhone(), user.getWebsite(),
					user.getCompany(), 0L));
		}
		return profiles;
