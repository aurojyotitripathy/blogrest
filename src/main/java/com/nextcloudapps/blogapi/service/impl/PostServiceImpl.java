...
import com.nextcloudapps.blogapi.repository.CategoryRepository;
...
public class PostServiceImpl implements PostService {
	...
	public PagedResponse<Post> getPostsByCategory(Long id, int page, int size) {
		...
		Category category = categoryRepository.findById(id)
				.orElseThrow(() -> new ResourceNotFoundException(AppConstants.CATEGORY, AppConstants.ID, id));
	...
	public PagedResponse<Post> getPostsByTag(Long id, int page, int size) {
		...
		Tag tag = tagRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException(AppConstants.TAG, AppConstants.ID, id));
	...
	public Post updatePost(Long id, PostRequest newPostRequest, UserPrincipal currentUser) {
		Post post = postRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException(AppConstants.POST, AppConstants.ID, id));
		Category category = categoryRepository.findById(newPostRequest.getCategoryId())
				.orElseThrow(() -> new ResourceNotFoundException(AppConstants.CATEGORY, AppConstants.ID, newPostRequest.getCategoryId()));
	...
	public PostResponse addPost(PostRequest postRequest, UserPrincipal currentUser) {
		...
		Category category = categoryRepository.findById(postRequest.getCategoryId())
				.orElseThrow(() -> new ResourceNotFoundException(AppConstants.CATEGORY, AppConstants.ID, postRequest.getCategoryId()));
